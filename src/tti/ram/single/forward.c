  ...
  for (int time = time_m; time <= time_M; time += 1)
  {
        ...
        for (int y0_blk0 = y_m; y0_blk0 <= y_M; y0_blk0 += y0_blk0_size)
        {
          for (int x = x0_blk0 - 2, xs = 0; x <= MIN(x0_blk0 + x0_blk0_size, x_M + 1); x += 1, xs += 1)
          {
            for (int y = y0_blk0 - 2, ys = 0; y <= MIN(y0_blk0 + y0_blk0_size, y_M + 1); y += 1, ys += 1)
            {
              ...
              for (int z = z_m - 2; z <= z_M + 1; z += 1)
              {
                float r26 = 5.00000007e-2F*v[time][x + 7][y + 7][z + 7];
                float r25 = 5.00000007e-2F*u[time][x + 7][y + 7][z + 7];
                r22[xs][ys][z + 2] = -(r25 + 1.66666669e-2F*u[time][x + 5][y + 7][z + 7] - 1.0e-1F*u[time][x + 6][y + 7][z + 7] + 3.33333338e-2F*u[time][x + 8][y + 7][z + 7])*r2[x + 2][y + 2][z + 2] - (r25 + 1.66666669e-2F*u[time][x + 7][y + 5][z + 7] - 1.0e-1F*u[time][x + 7][y + 6][z + 7] + 3.33333338e-2F*u[time][x + 7][y + 8][z + 7])*r3[x + 2][y + 2][z + 2] - (r25 + 1.66666669e-2F*u[time][x + 7][y + 7][z + 5] - 1.0e-1F*u[time][x + 7][y + 7][z + 6] + 3.33333338e-2F*u[time][x + 7][y + 7][z + 8])*r1[x + 2][y + 2][z + 2];
                r23[xs][ys][z + 2] = -(r26 + 1.66666669e-2F*v[time][x + 5][y + 7][z + 7] - 1.0e-1F*v[time][x + 6][y + 7][z + 7] + 3.33333338e-2F*v[time][x + 8][y + 7][z + 7])*r2[x + 2][y + 2][z + 2] - (r26 + 1.66666669e-2F*v[time][x + 7][y + 5][z + 7] - 1.0e-1F*v[time][x + 7][y + 6][z + 7] + 3.33333338e-2F*v[time][x + 7][y + 8][z + 7])*r3[x + 2][y + 2][z + 2] - (r26 + 1.66666669e-2F*v[time][x + 7][y + 7][z + 5] - 1.0e-1F*v[time][x + 7][y + 7][z + 6] + 3.33333338e-2F*v[time][x + 7][y + 7][z + 8])*r1[x + 2][y + 2][z + 2];
              }
            }
          }
          for (int x = x0_blk0, xs = 0; x <= MIN(x0_blk0 + x0_blk0_size - 1, x_M); x += 1, xs += 1)
          {
            for (int y = y0_blk0, ys = 0; y <= MIN(y0_blk0 + y0_blk0_size - 1, y_M); y += 1, ys += 1)
            {
              ...
              for (int z = z_m; z <= z_M; z += 1)
              {
                ...
                float r27 = 3.33333338e-2F*(-r1[x + 1][y + 1][z]*r22[xs + 1][ys + 1][z] - r2[x][y + 1][z + 1]*r22[xs][ys + 1][z + 1] - r22[xs + 1][ys][z + 1]*r3[x + 1][y][z + 1]) + 5.00000007e-2F*(-r1[x + 1][y + 1][z + 1]*r22[xs + 1][ys + 1][z + 1] - r2[x + 1][y + 1][z + 1]*r22[xs + 1][ys + 1][z + 1] - r22[xs + 1][ys + 1][z + 1]*r3[x + 1][y + 1][z + 1]) + 1.0e-1F*(r1[x + 1][y + 1][z + 2]*r22[xs + 1][ys + 1][z + 2] + r2[x + 2][y + 1][z + 1]*r22[xs + 2][ys + 1][z + 1] + r22[xs + 1][ys + 2][z + 1]*r3[x + 1][y + 2][z + 1]) + 1.66666669e-2F*(-r1[x + 1][y + 1][z + 3]*r22[xs + 1][ys + 1][z + 3] - r2[x + 3][y + 1][z + 1]*r22[xs + 3][ys + 1][z + 1] - r22[xs + 1][ys + 3][z + 1]*r3[x + 1][y + 3][z + 1]) + 1.11111109e-4F*(u[time][x + 3][y + 6][z + 6] + u[time][x + 6][y + 3][z + 6] + u[time][x + 6][y + 6][z + 3] + u[time][x + 6][y + 6][z + 9] + u[time][x + 6][y + 9][z + 6] + u[time][x + 9][y + 6][z + 6]) + 1.49999997e-3F*(-u[time][x + 4][y + 6][z + 6] - u[time][x + 6][y + 4][z + 6] - u[time][x + 6][y + 6][z + 4] - u[time][x + 6][y + 6][z + 8] - u[time][x + 6][y + 8][z + 6] - u[time][x + 8][y + 6][z + 6]) + 1.49999997e-2F*(u[time][x + 5][y + 6][z + 6] + u[time][x + 6][y + 5][z + 6] + u[time][x + 6][y + 6][z + 5] + u[time][x + 6][y + 6][z + 7] + u[time][x + 6][y + 7][z + 6] + u[time][x + 7][y + 6][z + 6]) - 8.16666648e-2F*u[time][x + 6][y + 6][z + 6];
                u[time + 1][x + 6][y + 6][z + 6] = r28*(r5*damp[x + 1][y + 1][z + 1]*u[time][x + 6][y + 6][z + 6] + r27*(2*epsilon[x + 8][y + 8][z + 8] + 1) + r29*(-r4*(-2.0F*u[time][x + 6][y + 6][z + 6]) - r4*u[time - 1][x + 6][y + 6][z + 6]) + (r30 + r31 + r32 + r33)*r0[x + 2][y + 2][z + 2]);
                v[time + 1][x + 6][y + 6][z + 6] = r28*(r5*damp[x + 1][y + 1][z + 1]*v[time][x + 6][y + 6][z + 6] + r27*r0[x + 2][y + 2][z + 2] + r29*(-r4*(-2.0F*v[time][x + 6][y + 6][z + 6]) - r4*v[time - 1][x + 6][y + 6][z + 6]) + r30 + r31 + r32 + r33);
              }
            }
          }
        }
    ...
    #pragma omp parallel num_threads(nthreads_nonaffine)
    {
      ...
      for (int p_src = p_src_m; p_src <= p_src_M; p_src += 1)
      {
        ...
        if (ii_src_0 >= x_m - 1 && ii_src_1 >= y_m - 1 && ii_src_2 >= z_m - 1 && ii_src_0 <= x_M + 1 && ii_src_1 <= y_M + 1 && ii_src_2 <= z_M + 1)
        {
          ...
          u[time + 1][ii_src_0 + 6][ii_src_1 + 6][ii_src_2 + 6] += r6;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_0 <= x_M + 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1)
        {
          ...
          #pragma omp atomic update
          u[time + 1][ii_src_0 + 6][ii_src_1 + 6][ii_src_3 + 6] += r7;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1)
        {
          ...
          #pragma omp atomic update
          u[time + 1][ii_src_0 + 6][ii_src_4 + 6][ii_src_2 + 6] += r8;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_3 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_3 <= z_M + 1 && ii_src_4 <= y_M + 1)
        {
          ...
          #pragma omp atomic update
          u[time + 1][ii_src_0 + 6][ii_src_4 + 6][ii_src_3 + 6] += r9;
        }
        if (ii_src_1 >= y_m - 1 && ii_src_2 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_2 <= z_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          u[time + 1][ii_src_5 + 6][ii_src_1 + 6][ii_src_2 + 6] += r10;
        }
        if (ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          u[time + 1][ii_src_5 + 6][ii_src_1 + 6][ii_src_3 + 6] += r11;
        }
        if (ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_5 >= x_m - 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          u[time + 1][ii_src_5 + 6][ii_src_4 + 6][ii_src_2 + 6] += r12;
        }
        if (ii_src_3 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_5 >= x_m - 1 && ii_src_3 <= z_M + 1 && ii_src_4 <= y_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          u[time + 1][ii_src_5 + 6][ii_src_4 + 6][ii_src_3 + 6] += r13;
        }
        ...
        if (ii_src_0 >= x_m - 1 && ii_src_1 >= y_m - 1 && ii_src_2 >= z_m - 1 && ii_src_0 <= x_M + 1 && ii_src_1 <= y_M + 1 && ii_src_2 <= z_M + 1)
        {
          ...
          #pragma omp atomic update
          v[time + 1][ii_src_0 + 6][ii_src_1 + 6][ii_src_2 + 6] += r14;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_0 <= x_M + 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1)
        {
          ...
          #pragma omp atomic update
          v[time + 1][ii_src_0 + 6][ii_src_1 + 6][ii_src_3 + 6] += r15;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1)
        {
          ...
          #pragma omp atomic update
          v[time + 1][ii_src_0 + 6][ii_src_4 + 6][ii_src_2 + 6] += r16;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_3 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_3 <= z_M + 1 && ii_src_4 <= y_M + 1)
        {
          ...
          #pragma omp atomic update
          v[time + 1][ii_src_0 + 6][ii_src_4 + 6][ii_src_3 + 6] += r17;
        }
        if (ii_src_1 >= y_m - 1 && ii_src_2 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_2 <= z_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          v[time + 1][ii_src_5 + 6][ii_src_1 + 6][ii_src_2 + 6] += r18;
        }
        if (ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          v[time + 1][ii_src_5 + 6][ii_src_1 + 6][ii_src_3 + 6] += r19;
        }
        if (ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_5 >= x_m - 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1 && ii_src_5 <= x_M + 1)
        {
    ...
    #pragma omp parallel num_threads(nthreads_nonaffine)
    {
      ...
      for (int p_rec = p_rec_m; p_rec <= p_rec_M; p_rec += 1)
      {
        ...
        {
          sum += (u[time][ii_rec_0 + 6][ii_rec_1 + 6][ii_rec_2 + 6] + v[time][ii_rec_0 + 6][ii_rec_1 + 6][ii_rec_2 + 6])*(-1.0e-3F*px*py*pz + 1.0e-2F*px*py + 1.0e-2F*px*pz - 1.0e-1F*px + 1.0e-2F*py*pz - 1.0e-1F*py - 1.0e-1F*pz + 1);
        }
        if (ii_rec_0 >= x_m - 1 && ii_rec_1 >= y_m - 1 && ii_rec_3 >= z_m - 1 && ii_rec_0 <= x_M + 1 && ii_rec_1 <= y_M + 1 && ii_rec_3 <= z_M + 1)
        {
          sum += (u[time][ii_rec_0 + 6][ii_rec_1 + 6][ii_rec_3 + 6] + v[time][ii_rec_0 + 6][ii_rec_1 + 6][ii_rec_3 + 6])*(1.0e-3F*px*py*pz - 1.0e-2F*px*pz - 1.0e-2F*py*pz + 1.0e-1F*pz);
        }
        if (ii_rec_0 >= x_m - 1 && ii_rec_2 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_0 <= x_M + 1 && ii_rec_2 <= z_M + 1 && ii_rec_4 <= y_M + 1)
        {
          sum += (u[time][ii_rec_0 + 6][ii_rec_4 + 6][ii_rec_2 + 6] + v[time][ii_rec_0 + 6][ii_rec_4 + 6][ii_rec_2 + 6])*(1.0e-3F*px*py*pz - 1.0e-2F*px*py - 1.0e-2F*py*pz + 1.0e-1F*py);
        }
        if (ii_rec_0 >= x_m - 1 && ii_rec_3 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_0 <= x_M + 1 && ii_rec_3 <= z_M + 1 && ii_rec_4 <= y_M + 1)
        {
          sum += (-1.0e-3F*px*py*pz + 1.0e-2F*py*pz)*(u[time][ii_rec_0 + 6][ii_rec_4 + 6][ii_rec_3 + 6] + v[time][ii_rec_0 + 6][ii_rec_4 + 6][ii_rec_3 + 6]);
        }
        if (ii_rec_1 >= y_m - 1 && ii_rec_2 >= z_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_1 <= y_M + 1 && ii_rec_2 <= z_M + 1 && ii_rec_5 <= x_M + 1)
        {
          sum += (u[time][ii_rec_5 + 6][ii_rec_1 + 6][ii_rec_2 + 6] + v[time][ii_rec_5 + 6][ii_rec_1 + 6][ii_rec_2 + 6])*(1.0e-3F*px*py*pz - 1.0e-2F*px*py - 1.0e-2F*px*pz + 1.0e-1F*px);
        }
        if (ii_rec_1 >= y_m - 1 && ii_rec_3 >= z_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_1 <= y_M + 1 && ii_rec_3 <= z_M + 1 && ii_rec_5 <= x_M + 1)
        {
          sum += (-1.0e-3F*px*py*pz + 1.0e-2F*px*pz)*(u[time][ii_rec_5 + 6][ii_rec_1 + 6][ii_rec_3 + 6] + v[time][ii_rec_5 + 6][ii_rec_1 + 6][ii_rec_3 + 6]);
        }
        if (ii_rec_2 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_2 <= z_M + 1 && ii_rec_4 <= y_M + 1 && ii_rec_5 <= x_M + 1)
        {
          sum += (-1.0e-3F*px*py*pz + 1.0e-2F*px*py)*(u[time][ii_rec_5 + 6][ii_rec_4 + 6][ii_rec_2 + 6] + v[time][ii_rec_5 + 6][ii_rec_4 + 6][ii_rec_2 + 6]);
        }
        if (ii_rec_3 >= z_m - 1 && ii_rec_4 >= y_m - 1 && ii_rec_5 >= x_m - 1 && ii_rec_3 <= z_M + 1 && ii_rec_4 <= y_M + 1 && ii_rec_5 <= x_M + 1)
        {
          sum += 1.0e-3F*px*py*pz*(u[time][ii_rec_5 + 6][ii_rec_4 + 6][ii_rec_3 + 6] + v[time][ii_rec_5 + 6][ii_rec_4 + 6][ii_rec_3 + 6]);
        }
        rec[time][p_rec] = sum;
      }
    }
